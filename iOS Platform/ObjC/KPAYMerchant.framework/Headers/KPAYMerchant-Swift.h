...
SWIFT_CLASS("_TtC12KPAYMerchant12ThemeManager")
@interface ThemeManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) ThemeManager * _Nullable internalInstance;)
+ (ThemeManager * _Nullable)internalInstance SWIFT_WARN_UNUSED_RESULT;
+ (void)setInternalInstance:(ThemeManager * _Nullable)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ThemeManager * _Nonnull shared;)
+ (ThemeManager * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (ThemeObject * _Nonnull)getCurrentTheme SWIFT_WARN_UNUSED_RESULT;
- (ThemeObject * _Nonnull)getDefaultTheme SWIFT_WARN_UNUSED_RESULT;
- (ThemeObject * _Nonnull)getBackupTheme SWIFT_WARN_UNUSED_RESULT;
+ (void)loadTheme;
+ (void)unloadTheme;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
enum ThemeSide : NSInteger;

SWIFT_CLASS("_TtC12KPAYMerchant11ThemeObject")
@interface ThemeObject : NSObject
@property (nonatomic) enum ThemeSide side;
@property (nonatomic) BOOL isTranslucent;
@property (nonatomic, strong) UIColor * _Nonnull pageTitleBackgroundColor;
...
@property (nonatomic, strong) UIColor * _Nonnull textFieldForegroundColor;
@property (nonatomic, strong) UIColor * _Nonnull textFieldPlaceHolderColor;
@property (nonatomic, strong) UIColor * _Nonnull smallButtonTitleColor;
@property (nonatomic, strong) UIColor * _Nonnull smallButtonBackgroundColor;
@property (nonatomic, strong) UIColor * _Nonnull largeButtonTitleColor;
@property (nonatomic, strong) UIColor * _Nonnull largeButtonBackgroundColor;
@property (nonatomic, strong) UIColor * _Nonnull largeButtonBorderColor;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface ThemeObject (SWIFT_EXTENSION(KPAYMerchant))
- (void)backupThemeWithSide:(NSInteger)side bgColor:(UIColor * _Nullable)bgColor isTranslucent:(BOOL)isTranslucent foreColor:(UIColor * _Nullable)foreColor tintColor:(UIColor * _Nullable)tintColor tfBgColor:(UIColor * _Nullable)tfBgColor tfForeColor:(UIColor * _Nullable)tfForeColor tfPlaceHoldColor:(UIColor * _Nullable)tfPlaceHoldColor smBtnTitColor:(UIColor * _Nullable)smBtnTitColor smBtnBgColor:(UIColor * _Nullable)smBtnBgColor larBtnTitColor:(UIColor * _Nullable)larBtnTitColor larBtnBgColor:(UIColor * _Nullable)larBtnBgColor larBtnBorColor:(UIColor * _Nullable)larBtnBorColor viewStyle:(NSInteger)viewStyle;
@end

typedef SWIFT_ENUM(NSInteger, ThemeSide, closed) {
  ThemeSideLightSide = 0,
  ThemeSideDarkSide = 1,
};

typedef SWIFT_ENUM(NSInteger, ThemeViewStyle, closed) {
  ThemeViewStyleNone = 0,
  ThemeViewStyleStack = 1,
};
...
@interface UIView (SWIFT_EXTENSION(KPAYMerchant))
